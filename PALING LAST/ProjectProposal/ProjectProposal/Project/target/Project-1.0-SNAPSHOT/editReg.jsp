...
<%
    ...
    Regdoc regdoc = regDAO.getRegDogByCode(id);
%>

<h2>Edit Pendaftaran Perakuan KPT</h2>
<form action="RegController?action=edit" method="post" enctype="multipart/form-data">
    ...
    <table>
        ...
        <tr>
            ...
            <td><input type="text" name="id" value="<%= regdoc.getId() %>" readonly></td>
        </tr>
        <tr>
            <td>Program Akademik</td>
            <td><input type="text" name="programAkademik" readonly value="<%= regdoc.getProgramAkademik() %>"></td>
        </tr>
        <tr>
