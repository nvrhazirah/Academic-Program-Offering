                ...
                <thead class = "thead-dark">
                    <tr>
                        ...
                        <th scope="col">Delete</th>
                         <th scope="col">Arrange Meeting</th>
                    </tr>
                </thead>
                <tbody>
                    <%
                    ...
                    <tr>
                        ...
                        <td><a href="podoController?action=edit&progCode=<%= podoc.getProgCode() %>">Update</a></td>
                        <td><a href="podoController?action=delete&progCode=<%= podoc.getProgCode() %>">Delete</a></td>
                        <td><a href="MeetingController?action=insert&progCode=<%= podoc.getProgCode() %>">Arrange Meeting</a></td>
